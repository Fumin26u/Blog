        ...
        <div>
            ...
            <dd>
                <select name="stats" id="">
                    <option value="pending" @if($post->post_stats === 'pending') selected @endif>編集中</option>
                    <option value="private" @if($post->post_stats === 'private') selected @endif>非公開</option>
                    <option value="public" @if($post->post_stats === 'public') selected @endif>公開</option>
                </select>
            </dd>
        </div>
    </dl>
